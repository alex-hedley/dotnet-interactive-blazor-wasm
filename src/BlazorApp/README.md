...
No server is required — all code compilation and execution happens inside .NET 8 WebAssembly.

## How it works

1. On startup the app downloads `blazor.boot.json` to discover all managed assemblies deployed to `_framework/`.
